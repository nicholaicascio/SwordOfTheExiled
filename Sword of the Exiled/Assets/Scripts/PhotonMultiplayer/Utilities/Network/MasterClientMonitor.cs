...
{
    /// <summary>
    /// This should be a singleton.  It manages the pings of all the players involved.  
    /// Reasons to change the masterclient:
    /// When the master ping is way lower than everyone else.  Or, if the main has the game in the background.
    /// </summary>
