...
public class GuardSight : MonoBehaviour
{
    ...
    /// <summary>
    /// So, this is going to do a bunch of the setup stuff.  The problem is that because we are instantiating
    /// things over a network, things don't always exist when we want them to.
    /// </summary>
    private void Setup()
    {
        ...
        //Make sure we have everything we need.  If so, set allReady to true.
        if (player != null)
        {
            allReady = true;
